package com.example.coursework.modalWindows.windowsForReports;
...
public class ReportSecond {
    public static void newWindow(String title) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("views/viewsForReports/secondReport.fxml"));
